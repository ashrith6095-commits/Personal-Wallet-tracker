...
import { Mail, ArrowRight, DollarSign, Loader2, CheckCircle } from "lucide-react";
          ...
          <CardContent className="p-8">
            ...
            {isSubmitted ? (
              <div className="text-center">
                ...
                <Link
                  href="/login"
                  className="mt-6 inline-block font-medium text-indigo-500 hover:text-indigo-600 dark:text-indigo-400"
                >
                  Back to login
                </Link>
              </div>
